...
def run_experiment(dataset, input_data_shape, k, classifier_list, output_dir, batch_size, training_algorithm,
   ...
   Responsável pelo principal fluxo de execução da cGAN, realiza as chamada das funções de:
    ...
    dict_metrics={"TSTR accuracy":{"RandomForest":[],"AdaBoost":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         ...
         "TRTR accuracy":{"RandomForest":[],"AdaBoost":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         ...
         "TRTR precision":{"RandomForest":[],"AdaBoost":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         ...
         "TRTR F1 score":{"RandomForest":[],"AdaBoost":[],"DecisionTree":[],"Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]},
         ...
         "TRTR recall":{"RandomForest":[],"AdaBoost":[],"DecisionTree":[], "Perceptron":[],"SupportVectorMachine":[],"SGDRegressor":[],"XGboost":[]}}
    ...
    for i, (train_index, test_index) in enumerate(stratified.split(dataset.iloc[:, :-1], dataset.iloc[:, -1])):
        ...
        instance_classifier_TRTR = Classifiers()
        ...
        list_classifiers_TSTR = instance_classifier_TSTR.get_trained_classifiers(classifier_list, x_synthetic_training, y_synthetic_training,
                                                                                dataset_type, verbose_level, input_data_shape)
        list_classifiers_TRTR = instance_classifier_TRTR.get_trained_classifiers(classifier_list, x_training, y_training,
                                                                                dataset_type, verbose_level, input_data_shape)
        ...
        evaluate_TRTR_data(list_classifiers_TRTR, x_test, y_test, i, k, True, output_dir, classifier_list,
                           title_output, path_confusion_matrix, verbose_level, dict_metrics, dict_TSTR_auc)
...
def create_argparse():
    ...
    parser.add_argument("--dense_layer_sizes_g", type=list_of_ints,
                        default=DEFAULT_ADVERSARIAL_DENSE_LAYERS_SETTINGS_G,
                        help=" Valor das camadas densas do gerador")

    parser.add_argument("--dense_layer_sizes_d", type=list_of_ints, 
    ...
    parser.add_argument("--optimizer_generator_learning", type=float,
                        help='Taxa de aprendizado do gerador',
                        default=0.0001)
    parser.add_argument("--optimizer_discriminator_learning", type=float,
                        help='Taxa de aprendizado do discriminador',
                        default=0.0001)
...
if __name__ == "__main__":
    ...
    if arguments.dense_layer_sizes_g != DEFAULT_ADVERSARIAL_DENSE_LAYERS_SETTINGS_G:
        arguments.dense_layer_sizes_g = arguments.dense_layer_sizes_g
    print(arguments.dense_layer_sizes_g)
    
    if arguments.dense_layer_sizes_d != DEFAULT_ADVERSARIAL_DENSE_LAYERS_SETTINGS_D:
        arguments.dense_layer_sizes_d = arguments.dense_layer_sizes_d
    ...
    run_experiment(dataset_file, output_shape,
                   ...
                   latent_stander_deviation=arguments.latent_stander_deviation, num_samples_class_malware=arguments.num_samples_class_malware, num_samples_class_benign=arguments.num_samples_class_benign,optimizer_generator_learning=arguments.optimizer_generator_learning,optimizer_discriminator_learning=arguments.optimizer_discriminator_learning)
